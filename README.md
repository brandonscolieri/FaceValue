...
![Sample downsized images](more-imgs/cross-entropy.png)
...
*Figure 10. Accuracies for the second model for the first 25 epochs. We notice the validation accuracy plateauing around 30% after 25 epochs.*  
